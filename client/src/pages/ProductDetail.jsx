...
export default function ProductDetail() {
  ...
  const unitsPerStrip = Math.max(
    1,
    Number(p.units_per_strip || 1)
  );

  const stripsPerBox = Math.max(
    1,
    Number(
      p.strips_per_box ||
      (Number(p.units_per_box || unitsPerStrip) / unitsPerStrip) ||
      1
    )
  );

  const packageMrp = Number(
    p.regular_price ||
    p.mrp_price ||
    p.mrp ||
    0
  ...
  return (
    <>
      ...
      {cartNotice && (
        ...
        <div
          className={`fixed left-3 top-24 z-[160] w-[calc(100%-24px)] max-w-sm transition-all duration-300 ease-out sm:left-5 ${noticeVisible
      ...
      <main className="container-app py-10">
        ...
        <div className="mt-6 grid gap-10 lg:grid-cols-2">
              ...
              <div className="mt-3 grid grid-cols-5 gap-2">
                ...
                {imgs.map(x => (
                  ...
                  <button
                    ...
                    className={
                      `card aspect-square p-2 ${main === x.image_url
          ...
          <div>
              ...
              {options.map(o => {
                ...
                return (
                  ...
                  <button
                    ...
                    className={
                      `rounded-2xl border p-4 text-left transition ${selected?.key === o.key
            ...
            <div
              className={
                `mt-4 text-sm font-bold ${Number(p.stock) > 0
                  ? 'text-emerald-600'
                  : 'text-rose-600'
                }`
              }
