...
import {LayoutDashboard,Package,Shapes,Tags,Factory,Warehouse,Boxes,Truck,ClipboardList,Undo2,FileCheck,Users,Star,TicketPercent,Images,Mail,Stethoscope,CalendarDays,FileText,PanelsTopLeft,Navigation,MessageSquare,BarChart3,Settings,Shield,UserCog,ScrollText,Menu,X,LogOut,ChevronDown,Globe2,ShoppingBag,CreditCard} from 'lucide-react';
...
const groups=[
  ...
  ['Inventory',[[Warehouse,'Stock & Batches','/admin/inventory','inventory.view'],[ShoppingBag,'Purchase Orders','/admin/purchase-orders','inventory.view'],[Boxes,'Suppliers','/admin/suppliers','inventory.view'],[Truck,'Shipping Zones','/admin/shipping-zones','settings.manage']]],
  ['Orders',[[ClipboardList,'All Orders','/admin/orders','orders.view'],[CreditCard,'Payments','/admin/payments','orders.view'],[Undo2,'Returns & Refunds','/admin/returns','orders.view']]],
  ['Pharmacy',[[FileCheck,'Prescriptions','/admin/prescriptions','prescriptions.view']]],
  ['Customers',[[Users,'Customers','/admin/customers','customers.view'],[Star,'Reviews','/admin/reviews','customers.view']]],
  ['Marketing',[[TicketPercent,'Quantity Offers','/admin/quantity-offers','marketing.view'],[TicketPercent,'Coupons','/admin/coupons','marketing.view'],[TicketPercent,'Offers','/admin/offers','marketing.view'],[Images,'Banners','/admin/banners','content.view'],[Mail,'Newsletter','/admin/newsletter','marketing.view']]],
  ['Healthcare',[[Stethoscope,'Services','/admin/services','content.view'],[CalendarDays,'Bookings','/admin/bookings','orders.view']]],
  ['Content',[[PanelsTopLeft,'Homepage','/admin/homepage','content.view'],[Navigation,'Navigation & Footer','/admin/navigation','content.view'],[FileText,'CMS Pages','/admin/pages','content.view'],[MessageSquare,'Contact Messages','/admin/messages','support.view'],[Mail,'Email Center','/admin/email-center','support.view'],[Mail,'Email Templates','/admin/email-templates','settings.manage']]],
  ['Reports',[[BarChart3,'Reports','/admin/reports','reports.view']]],
  ['Analytics',[[BarChart3,'Analytics Dashboard','/admin/analytics','reports.view']]],
  ['Integration Settings',[[Settings,'Payment Settings','/admin/settings/payment','settings.manage'],[Settings,'Email Settings','/admin/settings/email','settings.manage'],[Settings,'SMS Settings','/admin/settings/sms','settings.manage'],[Settings,'Notification Settings','/admin/settings/notification','settings.manage'],[Settings,'Analytics & Pixel','/admin/settings/analytics','settings.manage']]],
