...
for(const rel of [
  'client/src/App.jsx','client/src/pages/admin/AdminLayout.jsx','client/src/pages/admin/ProductForm.jsx','client/src/pages/admin/Settings.jsx','client/src/pages/admin/HomepageManager.jsx','client/src/pages/admin/Resources.jsx','client/src/pages/admin/OperationalPages.jsx','client/src/pages/admin/SystemPages.jsx','client/src/pages/admin/Procurement.jsx','client/src/pages/admin/Payments.jsx','client/src/components/admin/RichTextEditor.jsx','server/src/routes/admin.routes.js','server/src/routes/admin/catalog.routes.js','server/src/routes/admin/operations.routes.js','server/src/routes/admin/content.routes.js','server/src/routes/admin/system.routes.js','database/schema.sql','database/migrations/001_schema.sql','database/seed.sql','server/src/scripts/seed-sql.js','SETUP.md','docs/ADMIN.md','docs/product-import-example.json','database/migrations/003_integrations.sql','server/src/services/notifications.js','server/src/services/payments.js','client/src/pages/admin/IntegrationSettings.jsx'
]) mustFile(rel);
...
mustContain('client/src/pages/admin/ProductForm.jsx',['JSON','cover','Upload extra images','RichTextEditor']);
