...
r.get('/products', requirePermission('products.view'), asyncHandler(async (req, res) => {
  let { page = 1, limit = 30, q = '', status = '' } = req.query; page = Math.max(1, +page || 1); limit = Math.min(500, Math.max(1, +limit || 30));
